...
$(TARGETDIR)/JEVisualizer: $(SRCDIR)/main.cpp $(BUILDDIR)/controller.o $(BUILDDIR)/wav.o $(BUILDDIR)/mmp.o $(BUILDDIR)/visualizer.o $(BUILDDIR)/layer.o $(BUILDDIR)/drawer.o $(BUILDDIR)/filter.o $(BUILDDIR)/formulacolor.o $(BUILDDIR)/formula.o $(BUILDDIR)/fpe.o $(BUILDDIR)/trackcontroller.o $(BUILDDIR)/config.o
	$(CC) $(CFLAGS) $(SRCDIR)/main.cpp $(BUILDDIR)/controller.o $(BUILDDIR)/wav.o $(BUILDDIR)/mmp.o $(BUILDDIR)/visualizer.o $(BUILDDIR)/layer.o $(BUILDDIR)/drawer.o $(BUILDDIR)/filter.o $(BUILDDIR)/formulacolor.o $(BUILDDIR)/formula.o $(BUILDDIR)/fpe.o $(BUILDDIR)/trackcontroller.o $(BUILDDIR)/config.o -o $(TARGETDIR)/JEVisualizer  $(OPENCV_FLAGS)
